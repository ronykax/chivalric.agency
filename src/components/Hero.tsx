...
export default function Hero() {
  return (
    <div className="w-full bg-brand flex flex-col relative d:bg-[url('/branding/Castle.png')] bg-no-repeat" style={{backgroundPosition: "60% 15vh", backgroundSize: "contain"}}>
